...
public class Member implements Serializable, Parcelable {
    ...
    private class ToStringBuilder {
        public ToStringBuilder(Serializable serializable) {
        }
    }

    private class EqualsBuilder {
        public EqualsBuilder append(Long stationCode, Long stationCode1) {
            return null;
        }

        public String append(String stationCode, String stationCode1) {
            return stationCode;
        }
    }
}